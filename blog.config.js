...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '半步流年', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '时光匆匆，年华易逝', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://banbuliunian.top', // 网站地址
